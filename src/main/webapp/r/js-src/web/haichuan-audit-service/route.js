...
function projectRouteConfig($stateProvider, $urlRouterProvider, $ocLazyLoadProvider) {
    ...
    $stateProvider
        ...
        .state('field.storageList', {
            url: '/storageList',
            templateUrl: 'views/storageList.html',
            controller: 'StorageListController',
            controllerAs: 'vm',
            resolve: {
                loadMyFile: _lazyLoad([
                    'js/controllers/storage/storageListController.js'
                ])
            }
        })
        //教材编辑等管理
        .state('field.storageDetails', {
            url: '/storageDetails/:id',
            templateUrl: 'views/storageDetails.html',
            controller: 'StorageDetailController',
            controllerAs: 'vm',
            resolve: {
                loadMyFile: _lazyLoad([
                    'js/controllers/storage/storageDetailsController.js'
                ])
            }
        })      
